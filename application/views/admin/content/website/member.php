                    ...
                    <div class="content">
                        ...
                        <form action="" method="post" id="form">
                            <div class='btn-navigation'> 
                                ...
                                <div class='pull-right'>
                                    <a class="btn btn-primary" href="<?php echo site_url();?>adminkarir/member"><i class="fa fa-times-circle"></i> Bersihkan Pencarian</a>
                                </div>
                            </div>
                            <div class='row'>
                        ...
                        <div class="table-responsive">
                            <table class="hover">
                                ...
                                <tbody>
                                    ...
                                    $like_member[$cari] = $q;
                                    if ($jml_data > 0){
                                        foreach ($this->ADM->grid_all_member('*', 'member_created', 'DESC', $batas, $page, '', $like_member) as $row){
                                            ?>
                                            <tr>
                                                ...
                                                <td> <img src="<?php echo base_url()."assets/images/member/kecil_".$row->member_images;?>" style="width:120px;"/></td>
                                                <td align="center">
                                                    <!-- ========== EDIT DETAIL HAPUS ========== -->
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-right" role="menu">
                                                            <li>
                                                                <a  href="<?php echo site_url();?>adminkarir/member/detail/<?php echo $row->member_id; ?>" title="Detail"><i class='fa fa-eye'></i> Detail</a>
                                                            </li>
                                                        </ul>
                                                    </div>  
                        ...
                        <div id='pagination'>
                            ...
                            <div class='pagination-right'>
                                <ul class="pagination">
                                    <?php if ($jml_halaman > 1) { echo pages($halaman, $jml_halaman, 'adminkarir/member/view', $id=""); }?>
                                </ul>
                            </div>
                        </div>
                    </div>
                  ...
                  <table class="table">
                    ...
                    <tr>
                        ...
                        <td><table>
                          ...
                          <?php
                            $no =1;
                            $q = $this->db->query("SELECT * FROM cv WHERE member_id=$member->member_id ORDER BY cv_id DESC");
                    ...
                    <tr>
                        <td width="20%">Foto</td>
                        <td width="1%">:</td>
                        <td><img src="<?php echo base_url()."assets/images/member/kecil_".$member->member_images;?>" style="width:120px;"/></td>
                    </tr>
                        </table>
                <a class="btn btn-primary" href="<?php echo site_url();?>adminkarir/member"><i class="fa fa-arrow-left"></i> Kembali</a>
            </div>
        </div>
    </div>
</div>
